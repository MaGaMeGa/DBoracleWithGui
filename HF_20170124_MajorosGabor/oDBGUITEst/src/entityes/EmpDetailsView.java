...
public class EmpDetailsView implements Serializable {
  ...
  public String toString() {
    return "EmpDetailsView{" + "employeeId=" + employeeId + ", jobId=" + jobId + ", managerId=" + managerId + ", departmentId=" + departmentId + ", locationId=" + locationId + ", countryId=" + countryId + ", firstName=" + firstName + ", lastName=" + lastName + ", salary=" + salary + ", commissionPct=" + commissionPct + ", departmentName=" + departmentName + ", jobTitle=" + jobTitle + ", city=" + city + ", stateProvince=" + stateProvince + ", countryName=" + countryName + ", regionName=" + regionName + '}';
  }
